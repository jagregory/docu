...
namespace Docu.Tests.Parsing
{
    ...
    public class DocumentationXmlMatcherTests : BaseFixture
    {
        ...
        {
            var undocumentedMembers = DocumentableMemberFinder.GetMembersForDocumenting(new[] {typeof (First), typeof (Second), typeof (Third)});
            var snippets = new[] {@"<member name=""T:Example.Second"" />".ToNode()};
            var members = DocumentationXmlMatcher.DocumentMembers(undocumentedMembers, snippets);
        ...
        {
            var undocumentedMembers = DocumentableMemberFinder.GetMembersForDocumenting(new[] {typeof (First), typeof (GenericDefinition<>)});
        ...
        {
            var undocumentedMembers = DocumentableMemberFinder.GetMembersForDocumenting(new[] {typeof (First), typeof (GenericDefinition<>), typeof (GenericDefinition<,>)});
        ...
        {
            var undocumentedMembers = DocumentableMemberFinder.GetMembersForDocumenting(new[] {typeof (ClassWithOverload)});
        ...
        {
            var undocumentedMembers = DocumentableMemberFinder.GetMembersForDocumenting(new[] {typeof (HasGenericMethods)});
