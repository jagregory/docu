    ...
    public class Examples : BaseDocumentModelGeneratorFixture
    {
        ...
        public void ShouldHaveExampleForProperty()
        {
            ...
            var members = new IDocumentationMember[]
            {
                Type<Second>(@"<member name=""T:Example.Second"" />"),
                Property<Second>(@"
                <member name=""P:Example.Second.SecondProperty"">
                  <example>
                    void Something()
                    {
                      return;
            ...
            property.Example.ShouldMatchStructure(com =>
                                                  com.InlineText("void Something()\r\n{\r\n  return;\r\n}"));
        }
        ...
        public void ShouldHaveExampleForField()
        {
            ...
            var members = new IDocumentationMember[]
            {
                Type<Second>(@"<member name=""T:Example.Second"" />"),
                Field<Second>(@"
                <member name=""F:Example.Second.aField"">
                  <example>
                    void Something()
                    {
                      return;
        ...
        public void ShouldHaveExampleForEvent()
        {
            ...
            var members = new IDocumentationMember[]
            {
                Type<Second>(@"<member name=""T:Example.Second"" />"),
                Event<Second>(@"
                <member name=""E:Example.Second.AnEvent"">
                  <example>
                    void Something()
                    {
                      return;
        ...
        public void ShouldHaveExampleForType()
        {
            ...
            type.Example.ShouldMatchStructure(com =>
                                              com.InlineText("void Something()\r\n{\r\n  return;\r\n}"));
        }
    }
}