    ...
    public class Remarks : BaseDocumentModelGeneratorFixture
    {
        ...
        public void ShouldHaveRemarksForType()
        {
            ...
            var members = new[]
            {
                ...
                Type<Second>(@"<member name=""T:Example.Second""><remarks>Second remark</remarks></member>"),
            };
            var namespaces = model.Create(members);

            namespaces[0].Types[0].Remarks.CountShouldEqual(1);
            ((InlineText)namespaces[0].Types[0].Remarks[0]).Text.ShouldEqual("First remark");
            namespaces[0].Types[1].Remarks.CountShouldEqual(1);
            ((InlineText)namespaces[0].Types[1].Remarks[0]).Text.ShouldEqual("Second remark");
        }
        ...
        public void ShouldHaveRemarksForMethods()
        {
            ...
            var members = new[]
            {
                Method<Second>(@"<member name=""M:Example.Second.SecondMethod""><remarks>Second method</remarks></member>", x => x.SecondMethod()),
            ...
            namespaces[0].Types[0].Methods[0].Remarks.CountShouldEqual(1);
            ((InlineText)namespaces[0].Types[0].Methods[0].Remarks[0]).Text.ShouldEqual("Second method");
            namespaces[0].Types[0].Methods[1].Remarks.CountShouldEqual(1);
            ((InlineText)namespaces[0].Types[0].Methods[1].Remarks[0]).Text.ShouldEqual("Second method 2");
        }
        ...
        public void ShouldHaveRemarksForProperties()
        {
            ...
            namespaces[0].Types[0].Properties[0].Remarks.CountShouldEqual(1);
            ((InlineText)namespaces[0].Types[0].Properties[0].Remarks[0]).Text.ShouldEqual("Second property");
        }
        ...
        public void ShouldHaveRemarksForEvents()
        {
            ...
            namespaces[0].Types[0].Events[0].Remarks.CountShouldEqual(1);
            ((InlineText)namespaces[0].Types[0].Events[0].Remarks[0]).Text.ShouldEqual("An event");
        }
        ...
        public void ShouldHaveSummaryForFields()
        {
            ...
            namespaces[0].Types[0].Fields[0].Remarks.CountShouldEqual(1);
            ((InlineText)namespaces[0].Types[0].Fields[0].Remarks[0]).Text.ShouldEqual("A field");
        }
    }
}