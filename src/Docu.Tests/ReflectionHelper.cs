...
namespace Docu.Tests
{
    ...
    {
        public static bool IsMethodExpression<T>(Expression<Func<T, object>> expression)
        {
            return IsMethodExpression<T,object>(expression);
        }

        public static bool IsMethodExpression<T,U>(Expression<Func<T, U>> expression)
        {
            return (expression.Body as MethodCallExpression) != null;
        }
        ...
        private static MemberExpression getMemberExpression(LambdaExpression expression, bool enforceMemberExpression)
        {
        ...
        {
            return GetMethod<Func<T, object>>(expression);
        }
        ...
        {
            return GetMethod<Func<T, U>>(expression);
        }

        public static MethodInfo GetMethod<T, U, V>(Expression<Func<T, U, V>> expression)
        {
            return GetMethod<Func<T, U, V>>(expression);
        }
